                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <p align="center"><strong>Email:</strong> {{ $customize->email }}</p>
                            <p align="center"><strong>Contact No:</strong> {{ $customize->contact_no }}</p>
                            <p align="center"><strong>Itinerary:</strong> {{ $customize->itinerary->title }}</p>
                            <h4 align="center"><strong>Message</strong></h4>
                            <p align="center">{!! $customize->description  !!}</p>

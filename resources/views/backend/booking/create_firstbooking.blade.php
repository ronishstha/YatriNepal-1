                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form action="{{ route('backend.booking.post.firstcreate') }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Continue with booking procedures</button>

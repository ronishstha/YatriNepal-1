                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover">
                                ...
                                @if($i != 0)
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a href="{{ route('backend.destination.restore.all') }}" style="color:black">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-danger" id="confirm"><a href="{{ route('backend.destination.delete', ['destination_id' => $destination->id]) }}" style="color:white">Delete</a></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="allDelete" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                    <button type="button" class="btn btn-danger" id="confirm"><a href="{{ route('backend.destination.delete.all') }}" style="color:white">Delete</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

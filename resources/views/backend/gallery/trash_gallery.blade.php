                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title">Gallery Trash</h4>
                            <p class="category"></p>
                        </div>
                        <div class="card-content table-responsive">
                            <table class="table table-hover">
                                ...
                                @if($i != 0)
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a href="{{ route('backend.gallery.restore.all') }}" style="color:black">
                                    ...
                                    @foreach($galleries as $gallery)
                                        @if($gallery->status == "trash")
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn-edit"><a href="{{ route('backend.gallery.restore', ['gallery_id' => $gallery->id]) }}">Restore</a></button></td>
                                                <td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-danger" id="confirm"><a href="{{ route('backend.gallery.delete', ['gallery_id' => $gallery->id]) }}" style="color:white">Delete</a></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="allDelete" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                    <button type="button" class="btn btn-danger" id="confirm"><a href="{{ route('backend.gallery.delete.all') }}" style="color:white">Delete</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form action="{{ route('backend.photo.post.create') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="form-control" name="gallery" id="gallery">
                                                @if(count($galleries) == 0)
                                                    <option value=null>No gallery available</option>
                                                @endif
                                                @foreach($galleries as $gallery)
                                                    <option>{{ $gallery->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
